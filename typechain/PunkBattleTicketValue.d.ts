...
interface PunkBattleTicketValueInterface extends ethers.utils.Interface {
  functions: {
...
export class PunkBattleTicketValue extends BaseContract {
  ...
  interface: PunkBattleTicketValueInterface;
